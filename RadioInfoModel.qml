...
ListModel{
    ...
    ListElement{
        name: "BBC Radio 1"
        icon: "Artwork/logo/BBC Radio 1.png"
        info: "BBC Radio 1 is a British radio station operated by the British Broadcasting Corporation which also broadcasts internationally, specialising in modern and current popular music and chart hits throughout the day. Radio 1 provides alternative genres after 7:00 pm, including electronic dance, hip hop, rock, indie or interviews. It is aimed primarily at the 15–29 age group, although the average age of the UK audience in 2008 was 33."
        streamingUrl: "http://bbcmedia.ic.llnwd.net/stream/bbcmedia_intl_lc_radio1_p"
        site: "http://www.bbc.co.uk/radio1"
    }

    ListElement{
        name: "BBC Radio 2"
        icon: "Artwork/logo/BBC Radio 2.png"
        info: "BBC Radio 2 is one of the BBC's national radio stations and the most popular station in the United Kingdom.
                Much of its daytime playlist-based programming is best described as adult contemporary or AOR, although
                the station is also noted for its specialist broadcasting of other musical genres. Radio 2 broadcasts throughout the
    ...
    ListElement{
        ...
        icon: "Artwork/logo/BBC Radio 5 live.png"
    ...
    ListElement{
        name:"Magic 105.4"
        icon: "Artwork/logo/magic.png"
        info: "Magic 105.4 FM is an adult contemporary Independent Local Radio station based in London owned by Bauer Radio. The Station forms part of the Bauer Place Portfolio.
    As well as being carried on FM in London it is simulcast on several DAB multiplexes, online, and on digital television."
        streamingUrl: "http://icy-e-05.sharp-stream.com:80/magic1054.mp3"
    ...
    ListElement{
        name: "Rinse FM"
        icon: "Artwork/logo/rinse.png"
        info: "Rinse FM is a London-based community radio station, licensed for \"young people living and/or working within the central, east and south London areas.\". The station plays grime, dubstep, house, jungle and funky and other UK-centric dance music.
    The station was founded in 1994 and operated as pirate radio station until it was given a community FM broadcast license in June 2010."
        streamingUrl: "http://podcast.dgen.net:8000/rinseradio"
        site: "http://rinse.fm"
    }
